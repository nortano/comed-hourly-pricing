...
fun tilePreview(context: Context): TilePreviewData {
    ...
    val contentColumn =
        LayoutElementBuilders.Column
            ...
            .addContent(
                Text
                    .Builder(context, context.getString(R.string.price_with_unit, "2.4"))
                ...
                Text
                    .Builder(context, context.getString(R.string.as_of_time, "10:30 AM"))
    ...
    val primaryLayout =
        PrimaryLayout
            ...
            .setPrimaryLabelTextContent(
                Text
                    .Builder(context, context.getString(R.string.label_5min))
